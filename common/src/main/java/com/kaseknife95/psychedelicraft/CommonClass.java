...
import com.kaseknife95.psychedelicraft.Blocks.MyFirstBlocks;
import com.kaseknife95.psychedelicraft.CreativeTabs.CreativeTabs;
...
public class CommonClass {
    ...
    public static void init() {
        ...
        if (Services.PLATFORM.isModLoaded("psychedelicraft")) {
            Constants.LOG.info("Hello to psychedelicraft");
        }
    }
}
